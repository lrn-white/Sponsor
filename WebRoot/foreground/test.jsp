...
<body>
	...
	<div class="body1">
		...
		<table cellpadding="10px">
			<tr>
				...
				<td><a href="act-queryMutlCase?acProp=学校&acBudget=0" style="text-decoration:none">学校</a></td>
				<td><a href="act-queryMutlCase?acProp=学院" style="text-decoration:none">学院</a></td>
	...
	<div class="body2">
		...
		<s:iterator value="#request.queryMutlCase">
