...
<link rel="stylesheet" type="text/css" href="${yz}/css/mianWinodw.css" />
<title>活动详细信息</title>
...
<div class="head">
			...
			<a class="home" style="margin-left:20px;" href="mianWindow(c).html">首页</a>
