				...
				<ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
					<li><a href="#systemSetting" class="nav-header collapsed"
						...
						<ul id="systemSetting" class="nav nav-list collapse secondmenu"
							style="height: 0px;">
							<li><a href="user-input" target="right"><i
									class="glyphicon glyphicon-user"></i>管理员信息增加</a></li>
							<li><a href="user-list" target="right"><i
					...
					<li><a href="#systemSetting2" class="nav-header collapsed"
						...
						<ul id="systemSetting2" class="nav nav-list collapse thirdmenu"
							style="height: 0px;">
							<li><a href="com-list" target="right"><i
									class="glyphicon glyphicon-folder-open"></i>&nbsp;&nbsp;企业信息表</a></li>
							<li><a href="comm-list" target="right"><i
									class="glyphicon glyphicon-folder-open"></i>&nbsp;&nbsp;社团信息表</a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-folder-open"></i>&nbsp;&nbsp;活动信息表</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
